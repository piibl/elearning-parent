package fr.iut.csid.empower.elearning.web.mvc;
...
import fr.iut.csid.empower.elearning.web.domain.Artist;
import fr.iut.csid.empower.elearning.web.domain.Search;
import fr.iut.csid.empower.elearning.web.domain.User;
...
public class ExampleController {
	...
	public String example1(Model model) {
		...
		return "pages/examples/example1";
	}
	...
	public String setupForm(Model model) {
		...
		model.addAttribute("examples/search", new Search());
		return "pages/examples/example2";
	}
	...
	public String example3(Model model) {
		model.addAttribute("realText",
				"This is the real <strong>unescaped</strong> text at runtime");
		model.addAttribute("realEscapedText",
				"This is the real <strong>escaped</strong> text at runtime");
	...
	private List<Artist> getResults() {
		...
		results.add(new Artist(
				"Mariah",
				"Carrey",
				Arrays.asList("Mariah Carey", "Emotions", "Music Box",
						"Merry Christmas", "DayDream", "ButterFly"),
		...
		results.add(new Artist(
				"Elvis",
				"Presley",
				Arrays.asList("Elvis Presley", "Elvis", "Loving You",
						"Elvis' Christmas Album", "Elvis Is Back!",
						"G.I. Blues"),
		...
		results.add(new Artist(
				"John",
				"Lennon",
				Arrays.asList("John Lennon", "Imagine",

...
public class CourseSubscriptionServiceImpl extends AbstractCrudService<CourseSubscription, Long> implements CourseSubscriptionService {
	...
	public CourseSubscription subscribe(Student student, Long courseId) {
		...
		if (course != null) {
			...
			notificationService.createNotificationListTeacher("Inscrition à un cours", course.getCoursesTeaching(), "L'étudiant(e) " + student.getFirstName() + " " + student.getLastName() + " s'est inscrit(e) au cours " + course.getLabel() +".");
	...
	public String unsubscribe(Student student, Long courseId) {
		...
		if (course != null) {
			...
			notificationService.createNotificationListTeacher("Désinscription à un cours", course.getCoursesTeaching(), "L'étudiant(e) " + student.getFirstName() + " " + student.getLastName() + " s'est désinscrit(e) du cours " + course.getLabel() +".");
			return label;
		}
		throw new CourseNotExistsException();

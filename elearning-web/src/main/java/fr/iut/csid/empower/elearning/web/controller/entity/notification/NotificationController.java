...
public class NotificationController {
	 ...
	 * Celle-ci se base sur le postulat que l'utilisateur appelant est un
	 * étudiant. <br/>
	 * TODO cette fonction ne devrait pas être assumée par un controller de
	 * domaine.... Refactor à faire, conception à peaufiner
	 * 
	 * @param model
	 * @param courseId
	 * @param user
